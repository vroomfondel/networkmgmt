...
def main() -> None:
    ...
    repo_name = os.environ.get("GITHUB_REPOSITORY", "vroomfondel/networkmgmt")

    history_filename = "networkmgmt_clone_history.json"
    badge_filename = "networkmgmt_clone_count.json"
